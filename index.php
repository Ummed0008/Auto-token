...
// Telegram Bot Token
define('BOT_TOKEN', getenv('BOT_TOKEN') ?: '7775592769:AAEM8ye5pzujql0i8C7UOHa9YT8NyeNiDZY');
...
function generateAndUpdateToken($chat_id, $state, $message_id = null) {
    ...
    foreach ($state['json_data'] as $cred) {
        ...
        $api_url = "https://dholu-jwt.vercel.app/token?uid={uid}&password={password}";
